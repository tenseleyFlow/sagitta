...
void test_syn_defs_alias_include_and_rule_features_pack(void)
{
    ...
    YEW_ASSERT(def->rules[0].flags & YEW_SYN_RULE_FIRST_LINE);
    ...
    YEW_ASSERT_EQ_U64(def->rules[2].value_pred, SYN_VALUE_SET);
    ...
    YEW_ASSERT(def->rules[8].flags & YEW_SYN_RULE_ZERO_TRANSITION);
