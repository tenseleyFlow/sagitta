...
void test_lsp_lifecycle_method_not_found_clears_document_symbol_capability(void);
...
void test_lsp_lifecycle_document_highlight_separates_read_and_write_overlays(void);
void test_lsp_lifecycle_document_highlight_edit_clears_and_cancels_stale_response(void);
void test_lsp_lifecycle_document_highlight_cursor_rearm_rejects_stale_response(void);
...
void test_lsp_lifecycle_unfocused_method_not_found_clears_highlight_capability(void);
