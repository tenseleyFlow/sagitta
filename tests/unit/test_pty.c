...
void test_pty_environment_exact(void)
{
    ...
    /* NO_COLOR, the two opt-in profiling variables, the clipboard
     * override and Sprint 57.18's opt-in $PATH are absent from this
     * baseline. */
    YEW_ASSERT_EQ_U64((u64)YEW_ARRAY_LEN(expected) + 5U,
