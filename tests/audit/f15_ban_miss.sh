...
# YEW-F-065 compares exact generated content, so the neutral fixture starts
# from the checked-in output before an individual finding mutates it.
cp src/unicode/tables.c "$repo/src/unicode/tables.c"
printf '%s\n' \
