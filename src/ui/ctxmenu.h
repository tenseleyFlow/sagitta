#ifndef SAG_UI_CTXMENU_H
#define SAG_UI_CTXMENU_H
 ...
 *
 * (The sprint sketched `sag_ctx_draw(Ed *)` / `sag_ctx_key(Ed *, …)`.
 ...
 * for the duration of an invocation and sag_region_hit aborts if it is
