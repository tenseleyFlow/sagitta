...
static const CmdDesc builtins[] = {
    ...
    {"ed.compl.complete", yew_compl_cmd_complete, YEW_ARITY_NONE,
     YEW_CMD_NEEDS_WIN | YEW_CMD_PROMPTS,
     "Request completion from LSP or the core index", NULL},
    ...
    {"ed.move.word.prev", yew_edit_cmd_move_word_prev, YEW_ARITY_NONE,
     YEW_CMD_REPEATABLE | YEW_CMD_RECORDABLE | YEW_CMD_NEEDS_WIN,
     "Move to the previous word start", "prev_word"},
    {"ed.move.word.next", yew_edit_cmd_move_word_next, YEW_ARITY_NONE,
     YEW_CMD_REPEATABLE | YEW_CMD_RECORDABLE | YEW_CMD_NEEDS_WIN,
     "Move to the next word start", "next_word"},
    ...
    {"ed.shell.open", yew_edit_cmd_shell_prompt, YEW_ARITY_NONE,
     YEW_CMD_INTERNAL,
     "Open the command line with a shell-command prefix", NULL},
    ...
    {"ed.sel.extend.left", yew_edit_cmd_sel_extend_left, YEW_ARITY_NONE,
     YEW_CMD_RECORDABLE | YEW_CMD_NEEDS_WIN,
     "Start or extend a character highlight left", "sel_extend_left"},
    {"ed.sel.extend.right", yew_edit_cmd_sel_extend_right, YEW_ARITY_NONE,
     YEW_CMD_RECORDABLE | YEW_CMD_NEEDS_WIN,
     "Start or extend a character highlight right", "sel_extend_right"},
    {"ed.sel.extend.up", yew_edit_cmd_sel_extend_up, YEW_ARITY_NONE,
     YEW_CMD_RECORDABLE | YEW_CMD_NEEDS_WIN,
     "Start or extend a character highlight up", "sel_extend_up"},
    ...
    {"ed.group.close", yew_group_cmd_close, YEW_ARITY_NONE, 0U,
     "Close the active group, or the active tab when ungrouped", NULL},
    ...
    {"ed.git.open_split_h", yew_fuss_cmd_open_split_h, YEW_ARITY_OPT_STR,
     YEW_CMD_NEEDS_WIN | YEW_CMD_RECORDABLE,
     "Open the selected path in a horizontal split", "git_open_split_h"},
...
static const BuiltinMeta builtin_meta[] = {
    ...
    {"ed.group.close", "", YEW_RP_FORBID, "gclose"},
