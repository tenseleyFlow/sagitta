...
## Baseline status — REQUALIFIED; ACTIVE AT F15
...
changes. F13 subsequently closed with four Medium findings
...
closed. Cross-front dedup retained all 75 front-close findings with no aliases
